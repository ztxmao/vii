...
// set timeout
func (this *FCGIClient) SetDeadline(timeout time.Time) {
	this.rwc.SetDeadline(timeout)
}

// set send_timeout
func (this *FCGIClient) SetWriteDeadline(timeout time.Time) {
	this.rwc.SetWriteDeadline(timeout)
}

// set read_timeout
func (this *FCGIClient) SetReadDeadline(timeout time.Time) {
	this.rwc.SetReadDeadline(timeout)
}
